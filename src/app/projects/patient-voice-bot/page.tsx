...
import { patientVoiceBotProject as p } from "@/data/content";
...
export default function PatientVoiceBotPage() {
  return (
      ...
      <Reveal delay={0.1}>
        <div className="mt-6 flex gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            onClick={() => trackEvent("github_click", { source: "project_patient_voice_bot" })}
            className="flex items-center gap-2 text-sm text-ink transition-colors hover:text-signal"
          >
